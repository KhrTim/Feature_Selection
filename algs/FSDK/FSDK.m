function [X_select,Obj_w,idxw,fea_id,t,converge] = FSDK(X,c_num,s_num,gamma,p,NITR_w,NITR_y)
% Using the code, please cite: Nie F, Ma Z, Wang J, et al. Fast Sparse Discriminative K-Means for Unsupervised Feature Selection[J]. 
% IEEE Transactions on Neural Networks and Learning Systems, early access, Jan 25, 2023, doi: 10.1109/TNNLS.2023.3238103.
% X：原始数据矩阵 n*d
